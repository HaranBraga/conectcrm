...
import { LayoutDashboard, Users, Send, Settings, Layers, Zap, MessageSquare, ClipboardList, CalendarDays } from "lucide-react";
  ...
  return (
    <aside className="flex flex-col w-60 bg-white border-r border-gray-200 shrink-0">
      ...
      <div className="px-5 py-4 border-t border-gray-100">
        <p className="text-xs text-gray-400">Conect CRM v0.1</p>
      </div>
    </aside>
  );
}
